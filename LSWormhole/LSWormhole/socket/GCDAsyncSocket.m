...
- (BOOL)enableBackgroundingOnSocketWithCaveat:(BOOL)caveat
{
	...
	r1 = CFReadStreamSetProperty(readStream, kCFStreamNetworkServiceType, (__bridge void*)PKPushTypeVoIP);
	r2 = CFWriteStreamSetProperty(writeStream, kCFStreamNetworkServiceType, (__bridge void*)PKPushTypeVoIP);
